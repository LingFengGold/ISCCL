...
def contextual_augment(data_source, data_target, textcol="text", aug_p=0.2, device1="cuda:1", device2="cuda:1"):
    ...
    augmenter2 = naw.ContextualWordEmbsAug(
        model_path='/home/st/disk0/nijuntong/bert-base-uncased', action="substitute", aug_min=1, aug_p=aug_p, device=device2)
...
def augment_files(datadir="./", targetdir="./", dataset="wiki1m_unique", aug_p=0.1, augtype="trans_subst"):
    ...
    device1=torch.cuda.set_device(1)
    ...
    if augtype == "word_deletion":
        ...
        augseq = contextual_augment(DataSource, DataTarget, textcol="text", aug_p=aug_p)
...
if __name__ == '__main__':
    ...
    datadir = "/home/st/disk0/nijuntong/STC/sccl/data"
    targetdir = "/home/st/disk0/nijuntong/STC/sccl/AugData"
