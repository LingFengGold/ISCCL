...
def explict_augmentation_loader(args):
    ...
    train_loader = util_data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=16)
    return train_loader
...
def unshuffle_loader(args):
    ...
    train_dataset = VirtualAugSamples(train_text, train_label)
    train_loader = util_data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=False, num_workers=16)   
    return train_loader
